...
#define STRING_CONFIG_H_AUTHOR "(Siarhei Klimuts, 28 Apr 2017)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {57.50, 57.50, 4000.00, 571.43}  // default steps per unit for Ultimaker
